use crate::{
  gp::MpOrs, solvers::genetic_algorithm::operators::mutation::Mutation, Domain, Pct, Solution,
};
...
mod tests {
  use crate::{
    solvers::genetic_algorithm::operators::mutation::{Mutation, RandomDomainAssignments},
    utils::dummy_mp,
    Pct,
  };
